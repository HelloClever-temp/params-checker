...
require 'validators/positive_num_field'
require 'shared_contexts/base'
require 'helper/base'

# rubocop:disable Metricts/BlockLength
RSpec.describe 'positive_num_field', type: :helper do
    ...
    describe 'check value' do
      describe 'check min' do
        context 'value is invalid' do
          let(:validator) { PositiveNumField::InvalidMinValueValidator }
  ...
  describe 'check default param_checker' do
    let(:validator) { PositiveNumField::DefaultValidator }
